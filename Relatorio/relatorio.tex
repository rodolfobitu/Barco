...
Ainda foi adicionado no `ÈS670_pp''o cíclo cooperativo, então foram colocadas 3 tasks: a que controla o estado do cooler através do botão, a que calcula a velocidade (utlizando sensores infravermelho) e a que chama a máquina de estdos.
